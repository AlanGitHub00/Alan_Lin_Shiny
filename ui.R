...
shinyUI(dashboardPage(
  ...
  dashboardBody(
    df <- data.frame(station=c("Times Square 42nd Street/Port Authority Bus Terminal", "Grand Central 42nd Street", 
                     ...
                     ridership2011=c(60604822, 42795505, 37731386, 34927178, 26758623, 24751771, 17971983, 21300892,
                               20377141, 19425347),
                     ridership2012=c(62069437, 42984249, 37154138, 34639575, 27010176, 24851746, 17868334, 21599586,
                               20628942, 19686985),
                     ridership2013=c(63617614, 44893301, 38213448, 35309414, 27730331, 25726374, 18721694, 22774421,
                               21282767, 20528208),
                     ridership2014=c(65948730, 46074652, 39285568, 35677468, 28638643, 26493571, 20102397, 23566961,
                               21557198, 20735032),
                     ridership2015=c(66359208, 46737564, 39541865, 35320623, 28309160, 26147434, 21671684, 23299666, 
                               21407792, 20890828),
                     ridership2016=c(64531511, 46121509, 39000352, 34289822, 27741367, 25183869, 25162937, 23203443, 
                               21000635, 20337593)),
    plot(
